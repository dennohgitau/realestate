...
const AllProperties = () => {
  ...
  const {
    ...
    current, setCurrent, setPageSize, pageCount,sorter,
    setSorter, filters, setFilters
  } = useTable();
          ...
          justifyContent="space-between" flexWrap="wrap">
            <Box display="flex" gap={2} flexWrap="wrap" mb={{xs: '20px', sm: 0}}>
                ...
                <Select
                  ...
                  {['Apartment', 'Villa', 'Farmhouse',
                'Condos', 'Townhouse', 'Duplex',
